        ...
        <div className={styles.container}>
            ...
            <div className={styles.subContainer}>
                <div className={styles.row1}>
                    <div className={styles.review}>
                        <Image className={styles.comillas} src={comillas} alt='comillas' quality={100} priority/>
                        <p className={styles.reviewText}>Hizo el reportaje de la comuion de mi hija y quedamos muy contentos.</p>
                        <Image className={styles.stars} src={stars} alt='5 estrellas' quality={100} priority/>
            ...
            <div className={styles.instagramPics}>
                <div className={styles.igPicContainer}>
                    <Image className={styles.igPic} src={ig1} alt='niña fotografía comunión Sevilla Davean' quality={100} priority/>
                </div>

                <div className={styles.igPicContainer}>
                    <Image className={styles.igPic} src={ig2} alt='hermanos fotografía comunión Sevilla Davean' quality={100} priority/>
                </div>

                <div className={styles.igPicContainer}>
                    <Image className={styles.igPic} src={ig3} alt='niño fotografía comunión Sevilla Davean' quality={100} priority/>
                </div>

                <div className={styles.igPicContainer}>
                    <Image className={styles.igPic} src={ig4} alt='niño fotografía comunión Sevilla Davean' quality={100} priority/>
                </div>

                <div className={styles.igPicContainer}>
                    <Image className={styles.igPic} src={ig5} alt='niño fotografía comunión Sevilla Davean' quality={100} priority/>
                </div>

                <div className={styles.igPicContainer}>
                    <Image className={styles.igPic} src={ig6} alt='niña fotografía comunión Sevilla Davean' quality={100} priority/>
                </div>
            </div>
        </div>
    )
