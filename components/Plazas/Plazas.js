        ...
        <div className={styles.container}>
            ...
            <div className={styles.title}>
                ...
                <div className={styles.lineLogo}>
                    ...
                    <Image className={styles.logo} quality={100} alt='logo davean' src={logo}/>
                    <div className={styles.line}></div>
                </div>
            ...
            <div className={styles.icons}>
                <div className={styles.iconContainer}>
                    <Image className={styles.icon} quality={100} alt='icono pack' src={icon1}/>
                ...
                <div className={styles.iconContainer}>
                    <Image className={styles.icon} quality={100} alt='icono reservar' src={icon3}/>
